...
function DateTime({input,setInput,errors, showMsg, setShowMsg}){
    ...
    return(
        <div className={style.info}>
            ...
            <input type='date' className={style.inputs} format='aaaa-mm-dd' name='start_date' onChange={handleStartDate} onBlur={handleBlur}  style={ showMsg.start_date && errors.start_date ? {border:'red 1px solid'}: {}}/>
            {showMsg.start_date&&(
