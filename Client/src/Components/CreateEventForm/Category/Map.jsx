...
export default function Map({ input, setInput }) {
  ...
  return (
    <>
      <Autocomplete
        id="google-map-demo"
        sx={{ width: "100%", marginTop: "18px" , backgroundColor: 'var(--ligth-background-color)'}}
